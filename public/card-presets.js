export const CARD_PRESETS = [
  ...
  },
  {
    ...
    card: {
      ...
      mastery: ['Level 1: Base', 'Level 2: Poison increases to 2', 'Level 3: Unlocks Fusion eligibility'],
      masteryThresholds: { level2: 25, level3: 55 },
      masteryDamageByLevel: { 1: 5, 2: 5, 3: 5 }
    }
  },
  {
    ...
    card: {
      ...
      range: 25,
      tags: ['Acid'],
      effect: 'Deal 4 Acid damage. Apply Poisoned 2.',
      damage: 4,
      damageType: 'Acid',
      targetEnemiesOnly: true,
      statusApply: {
      ...
      mastery: ['Level 1: Base', 'Level 2: Acid damage increases to 5', 'Level 3: Unlocks Fusion eligibility'],
      masteryThresholds: { level2: 25, level3: 55 },
      masteryDamageByLevel: { 1: 4, 2: 5, 3: 5 }
    }
  },
  {
    id: 'dust_cloud',
  ...
  },
  {
    ...
    card: {
      ...
      targetMode: 'multi_select',
      multiTargetMaxByLevel: { 1: 10, 2: 10, 3: 10 },
      zoneRadiusByLevel: { 1: 5, 2: 10, 3: 10 },
      zoneDurationTurns: 5,
  ...
  },
  {
    ...
    card: {
      ...
      targetEnemiesOnly: true,
      pushDistanceByLevel: { 1: 5, 2: 10, 3: 10 },
      mastery: ['Level 1: Base', 'Level 2: Push increases to 10 ft', 'Level 3: Unlocks Fusion eligibility'],
      masteryThresholds: { level2: 25, level3: 55 },
      masteryDamageByLevel: { 1: 6, 2: 6, 3: 6 }
    }
  },
  ...
  },
  {
    ...
    card: {
      ...
      targetMode: 'multi_select',
      multiTargetMaxByLevel: { 1: 10, 2: 10, 3: 10 },
      zoneRadiusByLevel: { 1: 10, 2: 10, 3: 10 },
      zoneDurationTurns: 2,
      mastery: ['Level 1: Base', 'Level 2: Damage increases to 5', 'Level 3: Unlocks Fusion eligibility'],
      masteryThresholds: { level2: 25, level3: 55 },
      masteryDamageByLevel: { 1: 4, 2: 5, 3: 5 }
    }
  },
  {
    ...
    card: {
      ...
      range: 30,
      tags: ['Lightning'],
      effect: 'Deal 6 Lightning damage to up to three targets.',
      damage: 6,
      damageType: 'Lightning',
      targetMode: 'multi_select',
      targetEnemiesOnly: true,
      multiTargetMaxByLevel: { 1: 3, 2: 3, 3: 3 },
      mastery: ['Level 1: Base', 'Level 2: Damage increases to 7 each', 'Level 3: Unlocks Fusion eligibility'],
      masteryThresholds: { level2: 25, level3: 55 },
      masteryDamageByLevel: { 1: 6, 2: 7, 3: 7 }
    }
  },
  {
    ...
    card: {
      ...
      mastery: ['Level 1: Base', 'Level 2: Root increases to 2', 'Level 3: Unlocks Fusion eligibility'],
      masteryThresholds: { level2: 25, level3: 55 },
      masteryDamageByLevel: { 1: 8, 2: 8, 3: 8 }
    }
  },
  ...
  },
  {
    ...
    card: {
      ...
      rangeText: 'Self',
      tags: ['Earth'],
      effect: 'Create an 10 ft long earthen wall with 30 HP. 2 characters may hide behind the stone wall and benefit from full cover.',
      damage: 0,
      damageType: '',
      isConstruct: true,
      constructMode: 'utility',
      ...
      constructAp: 0,
      constructMaxHp: 30,
      constructMaxHpByLevel: { 1: 30, 2: 40, 3: 40 },
      constructUtilityKind: 'barrier',
      constructUtilityNote: 'Provides full cover for up to 2 characters.',
      mastery: ['Level 1: Base', 'Level 2: Wall HP increases to 40 HP', 'Level 3: Unlocks Fusion eligibility'],
      masteryThresholds: { level2: 25, level3: 55 }
    }
  },
  {
  ...
  },
  {
    ...
    card: {
      ...
      damageType: '',
      targetEnemiesOnly: true,
      pushDistanceByLevel: { 1: 15, 2: 20, 3: 20 },
      mastery: ['Level 1: Base', 'Level 2: Push increases to 20 ft', 'Level 3: Unlocks Fusion eligibility'],
      masteryThresholds: { level2: 25, level3: 55 }
    }
  }
];
